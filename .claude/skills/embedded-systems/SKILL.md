...
description: Expert embedded systems engineer specializing in microcontroller firmware, RTOS development, and hardware-software integration. Use this skill whenever the user asks about firmware, microcontroller code, bare-metal programming, interrupt handling, peripheral drivers (I2C, SPI, UART, CAN, BLE), RTOS tasks/scheduling (FreeRTOS, TI-RTOS, Zephyr), HAL/BSP development, DMA, linker scripts, bootloaders, low-power modes, watchdogs, or any code targeting ARM Cortex-M, ESP32, STM32, Nordic nRF, TI CC26xx/CC13xx, AVR, PIC, or RISC-V devices.
---
...
- Interrupt latency < 10μs�s maintained
